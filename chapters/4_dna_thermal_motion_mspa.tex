...
Fits to the first-passage model are obtained by performing a chi-squared fit of the numerical solution of Equation \ref{eqn:drift_diffusion2} to the data, allowing the parameters $\sigma$ and $D$ to vary.
