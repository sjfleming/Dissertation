...
The stochastic dynamics of the NeutrAvidin-ssDNA complex in MspA can be modeled as a drift-diffusion process that obeys the adjoint Smoluchowski equation.  The probability that MspA's narrowest constriction is at location $x$ along the ssDNA, having started at position $x_0$, written $p(x,t|x_0)$, obeys

\begin{equation}
\pard{p(x,t|x_0)}{t} + \frac{D}{k_B T} F(x) \pard{p(x,t|x_0)}{x} = D \pardd{p(x,t|x_0)}{x}
