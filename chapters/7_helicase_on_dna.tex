...
\begin{figure}[h]
\begin{centering}
\includegraphics[width=0.9\textwidth]{figures/helicase_data.pdf}
\caption[Data for helicase stepping along DNA]{...}
...
\caption[Helicase stepping along three molecules]{...}
