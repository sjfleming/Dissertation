...
\caption[MspA current versus voltage]{On the left is the current versus voltage relation measured for the M2-MspA nanopore in 1M KCl, 25mM phosphate buffer, pH 8.00, at room temperature.  On the right, current is plotted as a function of time at +100mV and -100mV bias.  At 3 seconds, the applied voltage is switched from +100mV to -100mV.  It can be seen that the nanopore spontaneously closes periodically at -100mV bias.  This is referred to as ``gating."}
\label{fig:iv_mspa}
\end{centering}
\end{figure}
