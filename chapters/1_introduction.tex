...
%A few basic calculations about nanopore electrostatics can be found in Appendix \ref{np_calcs}.
...
% A simplified model is put forth to explain one contribution to the residual ionic current measured when a given DNA sequence is in the nanopore.
